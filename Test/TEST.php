    ...
    <div class="container">
        <div class="main">
            <div class="grid">
                ...
                <div class="opt">
                    <div>
                        <button class="opt_btn" name="BTN_DOC_CREATE" id="BTN_DOC_CREATE">CREATE</button>
                        <button class="opt_btn" name="BTN_DOC_SEND" id="BTN_DOC_SEND">SEND</button>
                        <button class="opt_btn" name="BTN_DOC_ATTACHMENTS" id="BTN_DOC_ATTACHMENTS">ATTACHMENTS</button>
                    </div>
                </div>
